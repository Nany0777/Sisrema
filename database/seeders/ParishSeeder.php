...
class ParishSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $parishes = [
            ...
            [977, 389, 'San Luis'],
            [978, 389, 'Mercedes Díaz'],
            [979, 390, 'Caraballeda'],
            [980, 390, 'Carayaca'],
            [981, 390, 'Carlos Soublette'],
            [982, 390, 'Caruao Chuspa'],
            [983, 390, 'Catia La Mar'],
            [984, 390, 'El Junko'],
            [985, 390, 'La Guaira'],
            [986, 390, 'Macuto'],
            [987, 390, 'Maiquetía'],
            [988, 390, 'Naiguatá'],
            [989, 390, 'Urimare'],
            [990, 391, 'Arístides Bastidas'],
            [991, 392, 'Bolívar'],
            [992, 407, 'Chivacoa'],
            [993, 407, 'Campo Elías'],
            [994, 408, 'Cocorote'],
            [995, 409, 'Independencia'],
            [996, 410, 'José Antonio Páez'],
            [997, 411, 'La Trinidad'],
            [998, 412, 'Manuel Monge'],
            [999, 413, 'Salóm'],
            [1000, 413, 'Temerla'],
            [1001, 413, 'Nirgua'],
            [1002, 414, 'San Andrés'],
            ...
            [1009, 418, 'El Guayabo'],
            [1010, 418, 'Farriar'],
            [1011, 441, 'Isla de Toas'],
            [1012, 441, 'Monagas'],
            [1013, 442, 'San Timoteo'],
            [1014, 442, 'General Urdaneta'],
            [1015, 442, 'Libertador'],
            [1016, 442, 'Marcelino Briceño'],
            [1017, 442, 'Pueblo Nuevo'],
            [1018, 442, 'Manuel Guanipa Matos'],
            [1019, 443, 'Ambrosio'],
            [1020, 443, 'Carmen Herrera'],
            [1021, 443, 'La Rosa'],
            [1022, 443, 'Germán Ríos Linares'],
            [1023, 443, 'San Benito'],
            [1024, 443, 'Rómulo Betancourt'],
            [1025, 443, 'Jorge Hernández'],
            [1026, 443, 'Punta Gorda'],
            [1027, 443, 'Arístides Calvani'],
            [1028, 444, 'Encontrados'],
            [1029, 444, 'Udón Pérez'],
            [1030, 445, 'Moralito'],
            [1031, 445, 'San Carlos del Zulia'],
            [1032, 445, 'Santa Cruz del Zulia'],
            [1033, 445, 'Santa Bárbara'],
            [1034, 445, 'Urribarrí'],
            [1035, 446, 'Carlos Quevedo'],
            [1036, 446, 'Francisco Javier Pulgar'],
            [1037, 446, 'Simón Rodríguez'],
            [1038, 446, 'Guamo-Gavilanes'],
            [1039, 448, 'La Concepción'],
            [1040, 448, 'San José'],
            [1041, 448, 'Mariano Parra León'],
            [1042, 448, 'José Ramón Yépez'],
            [1043, 449, 'Jesús María Semprún'],
            [1044, 449, 'Barí'],
            [1045, 450, 'Concepción'],
            [1046, 450, 'Andrés Bello'],
            [1047, 450, 'Chiquinquirá'],
            [1048, 450, 'El Carmelo'],
            [1049, 450, 'Potreritos'],
            [1050, 451, 'Libertad'],
            [1051, 451, 'Alonso de Ojeda'],
            [1052, 451, 'Venezuela'],
            [1053, 451, 'Eleazar López Contreras'],
            [1054, 451, 'Campo Lara'],
            [1055, 452, 'Bartolomé de las Casas'],
            [1056, 452, 'Libertad'],
            [1057, 452, 'Río Negro'],
            [1058, 452, 'San José de Perijá'],
            [1059, 453, 'San Rafael'],
            [1060, 453, 'La Sierrita'],
            [1061, 453, 'Las Parcelas'],
            [1062, 453, 'Luis de Vicente'],
            [1063, 453, 'Monseñor Marcos Sergio Godoy'],
            [1064, 453, 'Ricaurte'],
            [1065, 453, 'Tamare'],
            [1066, 454, 'Antonio Borjas Romero'],
            [1067, 454, 'Bolívar'],
            [1068, 454, 'Cacique Mara'],
            [1069, 454, 'Carracciolo Parra Pérez'],
            [1070, 454, 'Cecilio Acosta'],
            [1071, 454, 'Cristo de Aranza'],
            [1072, 454, 'Coquivacoa'],
            [1073, 454, 'Chiquinquirá'],
            [1074, 454, 'Francisco Eugenio Bustamante'],
            [1075, 454, 'Idelfonzo Vásquez'],
            [1076, 454, 'Juana de Ávila'],
            [1077, 454, 'Luis Hurtado Higuera'],
            [1078, 454, 'Manuel Dagnino'],
            [1079, 454, 'Olegario Villalobos'],
            [1080, 454, 'Raúl Leoni'],
            [1081, 454, 'Santa Lucía'],
            [1082, 454, 'Venancio Pulgar'],
            [1083, 454, 'San Isidro'],
            [1084, 455, 'Altagracia'],
            [1085, 455, 'Faría'],
            [1086, 455, 'Ana María Campos'],
            [1087, 455, 'San Antonio'],
            [1088, 455, 'San José'],
            [1089, 456, 'Donaldo García'],
            [1090, 456, 'El Rosario'],
            [1091, 456, 'Sixto Zambrano'],
            [1092, 457, 'San Francisco'],
            [1093, 457, 'El Bajo'],
            [1094, 457, 'Domitila Flores'],
            [1095, 457, 'Francisco Ochoa'],
            [1096, 457, 'Los Cortijos'],
            [1097, 457, 'Marcial Hernández'],
            [1098, 458, 'Santa Rita'],
            [1099, 458, 'El Mene'],
            [1100, 458, 'Pedro Lucas Urribarrí'],
            [1101, 458, 'José Cenobio Urribarrí'],
            [1102, 459, 'Rafael Maria Baralt'],
            [1103, 459, 'Manuel Manrique'],
            [1104, 459, 'Rafael Urdaneta'],
            [1105, 460, 'Bobures'],
            [1106, 460, 'Gibraltar'],
            [1107, 460, 'Heras'],
            [1108, 460, 'Monseñor Arturo Álvarez'],
            [1109, 460, 'Rómulo Gallegos'],
            [1110, 460, 'El Batey'],
            [1111, 461, 'Rafael Urdaneta'],
            [1112, 461, 'La Victoria'],
            [1113, 461, 'Raúl Cuenca'],
            [1114, 447, 'Sinamaica'],
            [1115, 447, 'Alta Guajira'],
            [1116, 447, 'Elías Sánchez Rubio'],
            [1117, 447, 'Guajira'],
            [1118, 462, 'Altagracia'],
            [1119, 462, 'Antímano'],
            [1120, 462, 'Caricuao'],
            [1121, 462, 'Catedral'],
            [1122, 462, 'Coche'],
            [1123, 462, 'El Junquito'],
            [1124, 462, 'El Paraíso'],
            [1125, 462, 'El Recreo'],
            [1126, 462, 'El Valle'],
            [1127, 462, 'La Candelaria'],
            [1128, 462, 'La Pastora'],
            [1129, 462, 'La Vega'],
            [1130, 462, 'Macarao'],
            [1131, 462, 'San Agustín'],
            [1132, 462, 'San Bernardino'],
            [1133, 462, 'San José'],
            [1134, 462, 'San Juan'],
            [1135, 462, 'San Pedro'],
            [1136, 462, 'Santa Rosalía'],
            [1137, 462, 'Santa Teresa'],
            [1138, 462, 'Sucre (Catia]'],
            [1139, 462, '23 de enero'],
        ];

        foreach ($parishes as $parish) {
            DB::table('parishes')->insert([
                'id' => $parish[0],
                'id_municipality' => $parish[1],
                'parish' => $parish[2],
            ]);
        }
    }
